...
//            H2DBUtil.displayTableRows(conn, "employees_projects");
            ...
            String query = "select b.first_name, b.last_name,d.name from employees b left join departments d on b.department_id = d.id where b.id not in (select b.id from projects a  left join employees_projects c on c.project_id = a.id left join employees b on b.id=c.employee_id )";
